...
class OllamaApiModel extends ApiModel{
   ...
   * @param {string} system - The system message used to specify custom behavior. Override System config
  ...
  async generate(model, system, prompt, temperature, max_token) {
    let usedSys = this.systemContext // The system message used to specify custom behavior.
    if (system !=null && system != "") usedSys = system
